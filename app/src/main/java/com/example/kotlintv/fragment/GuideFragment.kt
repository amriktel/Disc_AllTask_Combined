...
class GuideFragment : Fragment(), FocusCallBack {
    ...
    fun onItemClick(listData: GuideInfoList) {
        val intent = Intent(activity, DetailsActivity::class.java)
        if (context != null) {
            intent.putExtra("id",listData.id)
            intent.putExtra("showName",listData.showName)
            intent.putExtra("imageUrl",listData.cardImageUrl)
            intent.putExtra("description",listData.description)
            intent.putExtra("duration",listData.duration)
            intent.putExtra("episode",listData.episode)
